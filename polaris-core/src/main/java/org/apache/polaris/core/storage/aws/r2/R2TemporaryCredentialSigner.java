...
public final class R2TemporaryCredentialSigner {
  ...
  /**
   * @param prefixes key prefixes as {@code
   *     CloudflareR2CredentialsStorageIntegration.normalizedPrefixes} produces them: the grant path
   *     minus one leading slash, trailing slash present, doubled slashes intact. Only an empty list
   *     means the whole bucket, and it omits the {@code paths} claim; a prefix of {@code "/"} is a
   *     real prefix and keeps the claim.
   */
